...
import { BASE_URL, changePassword, changePasswordUser } from '../../action/action';
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          lastName: currentUser.nickname ?? '',
          email: currentUser.email,
          phoneNumber: currentUser.phoneNumber ?? '',
        });
        setAvatarUrl( BASE_URL + currentUser.avatar);
      } catch (error) {
